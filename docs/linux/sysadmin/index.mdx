...
To avoid this,
you can use the `--` (double dash) to signify the end of options and treat further arguments as filenames.
For instance:
...
In some cases, programs don’t follow these conventions, so it's best to consult the documentation for these tools.
