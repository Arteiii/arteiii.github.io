...
<div style={{ display: 'flex', alignItems: 'center' }}>
  ...
  <img src={"/img/windows/wininternals/vbs/vbs_2023-11-28.svg"}  alt="Drawing to explain the Virtual Trust Levels (VTLs), sometimes referred to as Virtual Secure Mode (VSM)" />  
</div>
